...
{
    public GameObject TPlayerString;      // Ïðåôàá ñòðîêè
    ...
    public SteamVR_Behaviour_Pose Pos = null; // Õðàíèò ïðàâûé êîíòðîëëåð - ïîëå íàçíà÷àåòñÿ èç ðåäàêòîðà Unity
    ...
    public GameObject RightHand;   // Ïðàâûé êîíòðîëëåð 
    public GameObject PLinePref;   // Ïðåôàá ðåíäåð-ëó÷à
    private GameObject PLine;      // Ðåíäåð-ëó÷ 
