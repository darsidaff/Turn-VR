...
public class moveVR : MonoBehaviour
{
    ...
    public LayerMask groundLayer; // Ñëîé äëÿ ïðîâåðêè çåìëè

    // Ññûëêà íà SteamVR Input äëÿ äâèæåíèÿ (ïåðåìåííàÿ movement òèïà Vector2)
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("movementAction íå ïðèâÿçàíî. Ïðîâåðüòå íàñòðîéêè SteamVR Input.");
    ...
    private void HandleMovement()
    {
        ...
        {
            Debug.LogWarning("movementAction íå èíèöèàëèçèðîâàíî");
        }
    }
